...
const Navbar = () => {
  ...
  return (
   ...
   <div className="flex  items-center gap-2" >
        ...
        {/* Search */}
        <div className="flex items-center w-[500px] mr-20 bg-[#1f1f1f] rounded-full group duration-500    hover:shadow-[0px_0px_0px_.4px_white] transition-all ease-in-out  px-4 py-2 w-[400px] hover:bg-[#3f3f3f]">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="bg-white cursor-pointer text-black px-4 py-2 rounded-full text-sm font-semibold hover:scale-105 transition">
          Explore Premium
        </button>
        ...
        <HiOutlineBell className="text-xl cursor-pointer hover:text-white text-gray-300" />
        <BsPeople className="text-xl cursor-pointer hover:text-white text-gray-300" />
